...
@section('info')
  ...
  <meta name="keywords" content="{{$field->cate_tag}}" />
...
<link rel="stylesheet" type="text/css" href="{{asset('resources/org/ueditor/third-party/SyntaxHighlighter/shCoreDefault.css')}}">
<script type="text/javascript">
    SyntaxHighlighter.all();/*代码*/
</script>
@endsection