...
<head>
    ...
    <link href="{{asset('resources/rot/bootstrap/bootstrap.min.css')}}" rel="stylesheet">
    <!--[if lt IE 9]>
...
@show
<footer>
    <p>{{Config::get('web.copyright')}} <a href="http://www.miitbeian.gov.cn/" target="_blank">http://www.houdunwang.com</a> <a href="/">网站统计</a></p>
</footer>
