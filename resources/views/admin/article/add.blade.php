        ...
        <table class="add_tab">
            <tbody>
                ...
                <tr>
                    <th>缩略图：</th>
                    <td>
                        <input type="hidden" class="lg" name="art_thumb">
                ...
                {{--<tr>--}}
                    ...
                    {{--<td>--}}
                        ...
                        {{--</style>--}}
                        {{--<div>--}}
                            {{--<script id="editor" type="text/plain" style="max-width:1024px;min-width:600px;width:100%;height:500px;"  name="art_content"></script>--}}
                            {{--<script>--}}
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="editor">
                            ...
                            <textarea class="form-control" id='myEditor' name="art_content"></textarea>
                        </div>
                    </td>
                </tr>
                <tr>
