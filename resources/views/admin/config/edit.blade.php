	...
	<div class="result_wrap">
        ...
        <div class="result_content">
            <div class="short_wrap">
                ...
                <a href="{{url('admin/category')}}"><i class="fa fa-recycle"></i>全部配置项</a>
            </div>
        </div>
    </div>
    <!--结果集标题与配置项组件 结束-->
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="radio" name="field_type" value="radio" @if($field->field_type=='radio') checked @endif onclick="showTr()">raduio
                            <span><i class="fa fa-exclamation-circle yellow"></i>类型：inout textarea raduio</span>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th>排序：</th>
                        <td>
                            <input type="text" name="conf_order" value="0" value="{{$field->conf_order}}">
                        </td>
                    </tr>
                    <tr>
                        <th>说明：</th>
...
<script>
    function showTr(){
        ...
        if(type=='radio'){
            $('.field_value').show('fast');
        }else{
            $('.field_value').hide('fast');
        }
    }showTr();
</script>
@endsection